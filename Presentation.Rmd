...
$$\text{Cramers V} = +\sqrt{\frac{\chi^2}{n \cdot min(r-1, c-1)}}$$
...
- **Niveaukonstante**:  
- der Wert, bei dem die Regressionsgerade die y-Achse schneidet  (oder wie früher in Mathe: der *y-Achsenabschnitt*)
