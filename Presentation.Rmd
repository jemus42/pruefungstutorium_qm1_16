...
---------|----------|---------
`r sum(a01$K1)` | `r sum(a01$K2)` | `r sum(a01$K3)`
...
<div class="columns-2">
```{r A01_f}
formattable(a01, list(
            K1 = formatter("span", 
                 style = x ~ ifelse(x >= "0.75", style(color = "red", font.weight = "bold"), NA)),
            K2 = formatter("span", 
                 style = x ~ ifelse(x >= "0.64", style(color = "red", font.weight = "bold"), NA)),
            K3 = formatter("span", 
                 style = x ~ ifelse(x >= "0.5", style(color = "red", font.weight = "bold"), NA))))
```
</div>
...
## Aufgabe 9 | Gamma und verwandte Statistiken
